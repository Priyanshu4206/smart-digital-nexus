...
const servicesData = [
  ...
  },
  {
    ...
    description:
      'Leverage the power of artificial intelligence for your business with custom AI solutions.',
    features: [
  ...
  },
  {
    ...
    description:
      'Robust and scalable backend systems to power your applications with confidence.',
    features: [
      'API Development',
      'Database Design',
      'Cloud Integration',
  ...
  },
  {
    ...
    description:
      'Efficient database design and management to store and retrieve your data securely.',
    features: [
...
const Services = () => {
  useEffect(() => {
    window.scrollTo(0, 0)
    document.title = 'Our Services - Attica Corporation'
  }, [])
          ...
          <div className='container mx-auto px-6'>
            <div className='max-w-3xl mx-auto text-center'>
              ...
              <p className='text-lg text-foreground/80 mb-8'>
                ...
                business needs. Our expert team delivers high-quality services
                across web, mobile, and AI development.
              </p>
            </div>
          </div>
        </section>
                ...
                >
                  <Card hoverable className='h-full flex flex-col'>
                    ...
                    <CardContent className='h-full flex flex-col'>
                      ...
                      <p className='text-foreground/80 mb-6 flex-grow'>{service.tools}</p>
                      <Button variant='default' className='w-full'>
                        <Link to='/contact'>Request {service.title}</Link>
                      </Button>
                    </CardContent>
                  </Card>
                </div>
